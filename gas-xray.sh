...
cd /root/.acme.sh
bash acme.sh --register-account -m anisakansa6@gmail.com
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/lesta-2/ssh/main/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/lesta-2/ssh/main/vps.conf"
systemctl enable nginx
...
# install xray
wget -q -O /usr/local/bin/xray "https://raw.githubusercontent.com/lesta-2/wisang/main/xray"
